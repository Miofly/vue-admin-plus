...
export interface RouteMetaBasic {
  ...
  sideWidth?: number
  /** 在同一 tab 上的路由 */
  inSameTabKey: string | Symbol
}

declare module 'vue-router' {
  interface RouteLocationNormalized extends _RouteLocationBase {
    component?: RouteComponent | AsyncComponent;
    redirect?: RouteRecordRedirectOption;
    children?: RouteLocationNormalized[];
